        ...
        <form method="post" enctype="multipart/form-data" class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input class="form-control" name="email" id="inputEmail" placeholder="Email" type="email">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="confirm" class="col-lg-2 control-label">Confirn Password</label>
                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <select class="form-control" name="orientation" id="orientation">
                            <?php foreach ($orientations as $orientatin) : ?>
                                <option value="<?=$orientatin['id'];?>">
                                    <?=$orientatin['name'];?>
                                </option>
                            <?php endforeach;?>
                        </select>
